...
def main():
    ...
    if server_id and client_data:
        ...
        # Decide qual Gamertag usar para o banco:
        # 1) Se o jogador acabou de vincular, usamos a da sessão.
        # 2) Se não houver na sessão, pedimos para informar manualmente.
        ...
        if not gamertag_banco_clean:
            ...
            # Não damos stop, para não quebrar o fluxo do vínculo acima.
        else:
            # Verifica se a Gamertag existe em players
            if gamertag_banco_clean not in players:
                ...
                # Garante estruturas wallets e bank no client_data
