...
def main():
    ...
    if server_id:
        ...
        st.markdown("Preencha sua Gamertag exatamente como aparece no console para vincular ao servidor.")
        ...
        if "portal_gamertag" in st.session_state:
            ...
            st.markdown(f"**Usando Gamertag vinculada na sessão: {gamertag_banco}**")
            st.markdown("Se quiser usar outra Gamertag vinculada a este servidor, informe abaixo.")
        else:
            gamertag_banco = ""
        ...
        if not gamertag_banco_clean:
        ...
        elif "players" in locals() and gamertag_banco_clean not in players:
            st.markdown("""
            ...
            st.markdown(f"""
            **Jogador {gamertag_banco_clean}**
            
            - **Carteira:** {saldo_carteira} DzCoins  
            - **Banco:** {saldo_banco} DzCoins
            """)
